...
# run both the modified Reichstein et al. night-time and Lasslop et al. day-time partitioning methods
# these modifications allow the basal respiration rate to be different in the day than at night 
...
#Source the modified REddyProc routine
source("/Users/trevorkeenan/Dropbox (Climate)/27.partitioning1v3public/resources/REddyProc/R/PartitionGL10wInhibition.R")
# source the code that initializes sEddyProc2 class (allows for Rref_day to be added to the structure)
source("/Users/trevorkeenan/Dropbox (Climate)/27.partitioning1v3public/resources/REddyProc/R/EddyWinhibition.R")
# source the code that performs the night-time partitioning, using sEddyProc2
source("/Users/trevorkeenan/Dropbox (Climate)/27.partitioning1v3public/resources/REddyProc/R/EddyPartitioningWinhibition.R")
...
# get Rref from the DT method to pass to the NT method
